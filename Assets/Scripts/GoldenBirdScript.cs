...
public class GoldenBirdScript : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            HamsiScript hamsiScript = other.GetComponent<HamsiScript>();
            if (hamsiScript != null)
            {
                hamsiScript.ActivateWings();
                GoldenBirdSpawner.instance.OnGoldenBirdEaten();
                ScoreManager.instance.OnGoldenBirdEaten();
                Destroy(gameObject);
            }
        }
    }
